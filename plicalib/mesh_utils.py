...
def compute_vertex_normals(vertices: NDArray, faces: NDArray, normalize: bool = True, return_norm: bool = False) -> Tuple[NDArray, Optional[NDArray]]:
    """
...
def compute_cotangent_matrix(vertices: NDArray, faces: NDArray, return_cotangent_weights: bool = False) -> sparse.csr_matrix:
